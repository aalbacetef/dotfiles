return {
  ...
  { "goolord/alpha-nvim", commit = "3979b01cb05734331c7873049001d3f2bb8477f4", optional = true },
  ...
  { "neovim/nvim-lspconfig", version = "^1", optional = true },
  ...
  { "stevearc/aerial.nvim", version = "^2.6", optional = true },
